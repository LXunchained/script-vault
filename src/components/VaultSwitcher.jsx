    ...
    return (
        <div className="relative">
            ...
            >
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 group-hover:text-white">{t('header.vault')}</span>
                    ...
                    <>
                        ...
                        >
                            <div className="px-3 py-2 mb-2">
                                <span className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-500">{t('header.selectUniverse')}</span>
                            </div>
                                ...
                                {brands.map((brand) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-sm font-bold text-white group-hover:text-amber-400 transition-colors">{brand.name}</span>
                                            <span className="text-[10px] text-slate-500 font-medium">
                                                {brand.name.includes("Richesse") ? t('vault.desc.richesse') : brand.name.includes("Héritage") ? t('vault.desc.heritage') : t('vault.desc.tech')}
                                            </span>
                                        </div>
                                    </a>
                                ))}
                            ...
                            <div className="mt-2 pt-2 border-t border-white/5 px-2">
                                <div className="p-3 bg-gradient-to-r from-violet-600/20 to-amber-600/20 rounded-xl border border-white/5">
                                    <p className="text-[10px] text-slate-300 font-medium text-center italic">{t('header.nexusLink')}</p>
                                </div>
                            </div>
                        </motion.div>
                    </>
