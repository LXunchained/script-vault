...
const BEEHIIV_URL = 'https://embeds.beehiiv.com/subscribe';  // replace with Beehiiv embed URL
const GUIDE_URL   = 'https://github.com/LXunchained/script-vault/releases/download/video-staging/richesse_guide.pdf';
...
export default function Newsletter() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Open Beehiiv with prefilled email
                    ...
                    <div className="relative flex flex-col md:flex-row gap-12 items-center">
                        ...
                        <div className="flex-1">
                            ...
                            <h2 className="text-3xl md:text-4xl font-black text-white mb-4 tracking-tighter">
                                Stratégies <span className="text-amber-400">patrimoine</span><br />chaque semaine
                            </h2>
                            <p className="text-slate-400 mb-6 leading-relaxed">
                                Optimisation fiscale, investissement international, setup expatrié — directement dans ta boîte mail. Gratuit.
                            </p>
                            {/* Lead magnet */}
                            <a href={GUIDE_URL} target="_blank" rel="noopener noreferrer"
                                ...
                                Télécharger le guide gratuit : <strong className="text-white ml-1">Relocation Financière</strong>
                            </a>
                        </div>
                        ...
                        <div className="flex-1 w-full max-w-md">
                            {!sent ? (
                                <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                                    ...
                                    <p className="text-xs text-slate-600 text-center">No spam. Désabonnement en 1 clic.</p>
                                </form>
                            ) : (
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-slate-400 text-sm">Vérifie ta boîte mail pour confirmer.</p>
                                </div>
                            )}
                        </div>
                    </div>
